---
layout: page
title: Co-evolution of wing colour pattern and vision in butterflies
description: Study of vision in butterflies
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="assets/img/projects/phylo_morpho.png" title="Phylogeny <i>Morpho</i> butterflies" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
