...
<i>Perisphaerus</i> genus (Blaberidae, Perisphaerinae) include cockroaches living in Africa and Indonesia. Multiple radiation events have been describe in the Indonesian region, starting from birds by Wallace (1863) who assumed the physical geographic history as a diversification driver isolating various population on different islands (peripatric speciation).
